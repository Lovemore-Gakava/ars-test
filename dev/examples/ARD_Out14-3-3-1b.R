...
# Programme:    Generate code to produce ARD for Out14-3-3-1b
# Output:       Summary of Observed and Change from Baseline by Scheduled Visits - Vital Signs (Vertical)
